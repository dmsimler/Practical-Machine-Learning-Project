...
```{r, echo=FALSE, fig.path="figures/", fig.align='center', fig.cap='Figure 2: Distribution of the out-of-sample errors across 50 folds for the different models', fig.height=5, fig.show='asis'}
