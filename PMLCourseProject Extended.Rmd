...
panderOptions('table.alignment.default',"left")
pander(modelResultsPhase2$FinalModelSummaries, caption = "Table 4: Out-of-sample errors and final model parameters for the SCALED candidate classification models created for Phase 2.  The lower the OOS Error, the more accurate is its classifier.")
...
```{r, echo=FALSE, fig.path="figures/", fig.align='center', fig.cap='Figure 5: Distribution of the out-of-sample errors across 50 folds for the different SCALED models.  The lower (closer to zero) a distribution is, the more accurate is its classifier.', fig.height=5, warning=FALSE}
...
```{r, echo=FALSE, fig.path="figures/", fig.align='center', fig.cap='Figure 6: Distribution of the difference between out-of-sample errors across 50 folds for the different model pairwise comparisons', fig.height=6, fig.show='asis', warning=FALSE}
...
```{r, echo=FALSE, fig.path="figures/", fig.align='center', fig.cap='Figure 7: Heat map of predictions on the test set with five classes for each model type. The true classes are shown in the row labels while columns quantify the probabilities for each class (labeled A through E)', fig.height=10, fig.width=12, fig.show='asis', warning=FALSE}
